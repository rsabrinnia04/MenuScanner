...
*   **加大版相機對焦框**：本設計特別加寬相機掃描對焦線框（`280px` 寬），讓紙本選單的對齊擺放更輕鬆自在。
*   **完整數位翻譯菜單浮空疊加**：辨識成功後，會在中文紙本上方即時疊加追蹤一張大尺寸、極易閱讀的 3D 浮空金色框線數位菜單板，直接列出 **6 道主打人氣菜色**（台灣刈包、蝦仁炒飯、鹹香酥雞、烤醃豬肉、檸檬愛玉、太陽餅）。
*   **即時翻譯切換**：在頁面頂端切換不同語系標籤（英文 🇬🇧、印尼文 🇮🇩、越南文 🇻🇳、泰文 🇹🇭、韓文 🇰🇷）時，**A-Frame 空間中的 3D 浮空菜單板上所有菜色譯名與對話操作指引，會隨之百分之百即時同步翻譯更替**！
